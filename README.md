...
`pip install git+https://github.com/biomodels/BIOMD0000000135.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000135.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000135 as model`
...
Neurons?_ Figure1(J) subthreshold oscillations has been reproduced by
...
parameters and different stimulus function or events.a=0.05; b=0.26; c=-60;
d=0; V=-62; u=b*V;
